                        ...
                        <div class="block-content block-content-full">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-xl-9">
                                    ...
                                    <form class="mb-5" action="<?= site_url('admin/proses/save'); ?>" method="POST" > <!-- onsubmit="return false;"> -->
                                        ...
                                        <div class="form-group row">                                                    
                                            ...
                                            <div class="col-sm-8">
                                                <select class="js-select2 form-control" id="ecom" name="ecom[]" style="width: 100%;" data-placeholder="Silahkan pilih E-Commerce" multiple>
                                                    <option></option><!-- Required for data-placeholder attribute to work with Select2 plugin -->
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <textarea class="form-control form-control-alt" id="resi" name="resi" rows="15" placeholder=""></textarea> 
                                            </div>
                                        </div>
                                        <div class="form-group row">
