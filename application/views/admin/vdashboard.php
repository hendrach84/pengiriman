...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Dashboard Pengirimn">
        <meta name="author" content="WeSoft">
        <meta name="robots" content="noindex, nofollow">

        <!-- Open Graph Meta -->
        <meta property="og:title" content="Dashboard Pengirimn">
        <meta property="og:site_name" content="Pengiriman">
        <meta property="og:description" content="Dashboard Pengiriman">
    ...
    <body>
                    ...
                    <div class="content-side">
                        <ul class="nav-main">
                            <li class="nav-main-item">
                                <a class="nav-main-link active" href="<?= site_url('admin/dashboard') ?>">
                                ...
                                <div class="block-content block-content-full d-flex align-items-center justify-content-between">
                                    <div class="mr-3">
                                        ...
                                        <p class="text-muted mb-0">
                                            Total Shipment Today
                                        </p>
                                    </div>
                                    <div>
                                        <i class="fa fa-2x fa-shipping-fast text-danger"></i>
                                    </div>
                                </div>
                            </a>
                        </div>
                        <div class="col-md-6 col-xl-4">
                            <a class="block block-rounded block-link-pop" href="javascript:void(0)">
                                <div class="block-content block-content-full d-flex align-items-center justify-content-between">
                                    ...
                                    <div>
                                        <i class="fa fa-2x fa-shipping-fast text-primary"></i>
                                    </div>
                                </div>
                            </a>
                        </div>
                            ...
                            <a class="block block-rounded block-link-pop" href="javascript:void(0)">
                                <div class="block-content block-content-full d-flex align-items-center justify-content-between">
                                    <div class="mr-3">
                                        ...
                                        <p class="text-muted mb-0">
                                            Total <label class="text-primary mb-0"><?= date('F'); ?></label> Shipment
                                        </p>
                                    </div>
                                    <div>
                                        <i class="fa fa-2x fa-shipping-fast text-success"></i>
                                    </div>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="col-md-6 col-xl-6">
                            ...
                            <div class="block block-rounded">
                                <div class="block-header block-header-default">
                                    <h3 class="block-title">Pie Charts Expedition <?= date('F'); ?> </h3>
                                ...
                                <div class="block-content block-content-full text-center">
                                    <div class="py-3">
                                        <!-- Pie Chart Container -->
                                        <canvas id="cart_ekspedisi"></canvas>
                                    </div>
                                </div>
                            </div>
                            <!-- END Pie Chart -->
        ...
        <!-- Page JS Plugins -->
        <script src="../../src/assets/js/plugins/easy-pie-chart/jquery.easypiechart.min.js"></script>
        <script src="../../src/assets/js/plugins/jquery-sparkline/jquery.sparkline.min.js"></script>
        <script src="../../src/assets/js/plugins/chart.js/Chart.bundle.min.js"></script>
        
        <!-- Page JS Code -->
        <!-- <script src="../../src/assets/js/pages/be_comp_charts.min.js"></script> -->
...
<?php 
    $a=''; 
    $b='';
    $ttl_exp=count($ekspedisi); 
    for($i=0;$i<$ttl_exp;$i++){
        if ($i!=$ttl_exp-1) {
            $a.='"'.$ekspedisi[$i]['ekspedisi'].'",';
            $cmd="SELECT SUM(total_resi) AS total_resi
                  FROM tb_trx_pengiriman
                  WHERE id_ekspedisi='".$ekspedisi[$i]['id_ekspedisi']."' AND
                  TIMESTAMP BETWEEN '".date('Y-m')."-01 00:00:00' AND '".date('Y-m-d')." 23:59:59' ";
            $qArr=$this->db->query($cmd)->result_array()[0]['total_resi']; 
            $qArr=$qArr?$qArr:0;
            $b.=$qArr.",";
        } else {
            $a.='"'.$ekspedisi[$i]['ekspedisi'].'"';
                                ...
                                [
                                    {
                                        ...
                                        [
                                            <?php 
                                                for($i=0;$i<$ttl_exp;$i++){
                                                    if ($i!=$ttl_exp-1) { 
                                                        $exp = explode(')', $ekspedisi[$i]['kodewarna']);
                                                        echo '"'.implode(',1)', $exp).'",';    
                                                    } else {
                                                        $exp = explode(')', $ekspedisi[$i]['kodewarna']);
                                                        echo '"'.implode(',1)', $exp).'"';
