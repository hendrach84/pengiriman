...
<html lang="en">
    <head>
        ...
        <meta property="og:site_name" content="Master Users">
        <meta property="og:description" content="Data Users">
                ...
                <div class="js-sidebar-scroll">
                    ...
                    <div class="content-side">
                        <ul class="nav-main">
                            ...
                            <li class="nav-main-item">
                                <a class="nav-main-link active" href="<?= site_url('admin/users') ?>">
                                    <i class="nav-main-link-icon far fa-2x fa-user-circle text-success"></i>
                ...
                <div class="content">
                    ...
                    <div class="block block-rounded table-responsive">
                        <div class="block-header block-header-default">
                            <h3 class="block-title text-danger">Data Users</h3>
                            <a class="btn btn-hero-sm btn-hero-danger ml-0 mr-0" href="javascript:void(0)">
                                <i class="fa fa-plus-circle"></i> Add
                            </a>
                        </div>
                        <div class="block-content block-content-full">
                            <!-- DataTables init on table by adding .js-dataTable-full class, functionality is initialized in js/pages/be_tables_datatables.min.js which was auto compiled from _js/pages/be_tables_datatables.js -->
                            <table class="table table-bordered table-striped table-vcenter display details-control" id="user" style="width: 100%;">
                                <thead>
                                    <tr>
                                        <th>Username</th>
