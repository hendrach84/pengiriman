                ...
                <div class="content">
                    ...
                    <div class="block block-rounded">
                        <div class="block-header block-header-default">
                            <h3 class="block-title text-danger">Edit E-Commerce</h3>
                        </div>
                        <div class="block-content block-content-full">
                            <!-- Horizontal Layout -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-xl-9">
                                    ...
                                    <form class="mb-5" action="<?= site_url('admin/ecom/simpan_edit'); ?>" method="POST" > <!-- onsubmit="return false;"> -->
                                        <input type="hidden" name="id_ecom" value="<?= $ecom[0]['id_ecom'] ?>">
                                        <div class="form-group row">                                                    
                                            <label class="col-sm-4 col-form-label" for="ecom">E-Commerce</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control form-control-alt" id="ecom" name="ecom" placeholder="Nama E-Commerce" value="<?= $ecom[0]['nama_ecom'] ?>" required >
                                            </div>
                                        </div>
                                        <div class="form-group row">
