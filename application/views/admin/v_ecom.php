...
<html lang="en">
    <head>
        ...
        <title>Master E-commerce's</title>
        ...
        <meta property="og:site_name" content="Master E-commerce">
        <meta property="og:description" content="Data E-commerce">
                ...
                <div class="content">
                    ...
                    <div class="block block-rounded table-responsive">
                        <div class="block-header block-header-default">
                            <h3 class="block-title text-danger">Data E-commerce</h3>
                            <a class="btn btn-hero-sm btn-hero-danger ml-0 mr-0" href="<?=site_url('admin/ecom/tambah')?>">
                                <i class="fa fa-plus-circle"></i> Add
                            </a>
                        </div>
                        <div class="block-content block-content-full">
                            <!-- DataTables init on table by adding .js-dataTable-full class, functionality is initialized in js/pages/be_tables_datatables.min.js which was auto compiled from _js/pages/be_tables_datatables.js -->
                            <table class="table table-bordered table-striped table-vcenter" id="ecom" style="width: 100%;">
                                <thead>
                                    <tr>
                                        <th style="width: 15%;">ID E-commerce</th>
                                        <th style="width: 30%;">Nama E-commerce</th>
