...
<html lang="en">
    <head>
        ...
        <meta property="og:site_name" content="Edit Ekspedisi">
        <meta property="og:description" content="Edit Ekspedisi">
        ...
        <!-- Stylesheets -->
        <!-- Page JS Plugins CSS -->
        <link rel="stylesheet" href="../../../src/assets/js/plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css">
    ...
    <body>
                ...
                <div class="js-sidebar-scroll">
                    ...
                    <div class="content-side">
                        <ul class="nav-main">
                            ...
                            <li class="nav-main-item">
                                <a class="nav-main-link" href="<?=site_url('admin/ecom')?>">
                            ...
                            <li class="nav-main-item">
                                <a class="nav-main-link active" href="<?=site_url('admin/ekspedisi')?>">
                ...
                <div class="content">
                    ...
                    <div class="block block-rounded">
                        <div class="block-header block-header-default">
                            <h3 class="block-title text-danger">Edit Ekspedisi</h3>
                        </div>
                        <div class="block-content block-content-full">
                            <!-- Horizontal Layout -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-xl-9">
                                    ...
                                    <form class="mb-5" action="<?= site_url('admin/ekspedisi/simpan_edit'); ?>" method="POST" > <!-- onsubmit="return false;"> -->
                                        <input type="hidden" name="id_ekspedisi" value="<?=$ekspedisi[0]['id_ekspedisi'];?>">
                                        <div class="form-group row">                                                    
                                            <label class="col-sm-4 col-form-label" for="ekspedisi">Ekspedisi</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control form-control-alt" id="ekspedisi" name="ekspedisi" placeholder="Nama Ekspedisi" value="<?=$ekspedisi[0]['ekspedisi'];?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label" for="alamat">Alamat</label>
                                            <div class="col-sm-8">
                                                <textarea class="form-control form-control-alt" id="alamat" name="alamat" rows="5" placeholder="Alamat"><?=$ekspedisi[0]['alamat'];?></textarea> 
                                            </div>
                                        </div>
                                        <div class="form-group row">                                                    
                                            <label class="col-sm-4 col-form-label" for="telp1">Telp 1</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control form-control-alt" id="Telp1" name="telp1" placeholder="Telp 1" value="<?=$ekspedisi[0]['tlp1'];?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">                                                    
                                            <label class="col-sm-4 col-form-label" for="telp2">Telp 2</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control form-control-alt" id="Telp1" name="telp2" placeholder="Telp 2" value="<?=$ekspedisi[0]['tlp2'];?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">             
                                            <label class="col-sm-4 col-form-label" for="kodewarna">Kode Warna Cart</label>
                                            <div class="col-sm-8 js-colorpicker input-group" id="kode_warna" data-format="rgba">
                                                <input type="text" class="form-control" id="kodewarna" name="kodewarna" required placeholder="Kode Warna Wajib Pilih" value="<?=@$ekspedisi[0]['kodewarna'];?>" readonly>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-8 ml-auto">
                                                ...
                                                <a href="<?=site_url('admin/ekspedisi')?>" class="btn btn-primary">Cancel</a>
                                            </div>
                                        </div>
                                    </form>
        ...
        <script src="../../../src/assets/js/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js"></script>
        
        <script>jQuery(function () { Dashmix.helpers(['maxlength','colorpicker']); });</script>

        <script type="text/javascript">
            $(function () {
                $('#kode_warna').colorpicker({
                    <?php if(@$kiriman[0]['kodewarna']) { ?>
                      fallbackColor: "<?=$kiriman[0]['kodewarna'] ?>"
                    <?php } ?>
                });
            });
        </script>
