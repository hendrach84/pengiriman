                ...
                <div class="content">
                    ...
                    <div class="block block-rounded table-responsive">
                        <div class="block-header block-header-default">
                            <h3 class="block-title text-danger">Data Ekspedisi</h3>
                            <a class="btn btn-hero-sm btn-hero-danger ml-0 mr-0" href="<?=site_url('admin/ekspedisi/tambah')?>">
                                <i class="fa fa fa-plus-circle"></i> Add
                            </a>
                        </div>
                        <div class="block-content block-content-full">
                            <!-- DataTables init on table by adding .js-dataTable-full class, functionality is initialized in js/pages/be_tables_datatables.min.js which was auto compiled from _js/pages/be_tables_datatables.js -->
                            <table class="table table-bordered table-striped table-vcenter display" id="ekspedisi" style="width: 100%;">
                                <thead>
                                    <tr>
                                        <th>ID Ekspedisi</th>
