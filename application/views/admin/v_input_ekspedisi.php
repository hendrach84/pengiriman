...
<html lang="en">
    <head>
        ...
        <meta property="og:site_name" content="Tambah Ekspedisi">
        <meta property="og:description" content="Tambah Ekspedisi">
                ...
                <div class="content">
                    ...
                    <div class="block block-rounded">
                        <div class="block-header block-header-default">
                            <h3 class="block-title text-danger">Tambah Ekspedisi</h3>
                        </div>
                        <div class="block-content block-content-full">
                            <!-- Horizontal Layout -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-xl-9">
                                    ...
                                    <form class="mb-5" action="<?= site_url('admin/ekspedisi/simpan'); ?>" method="POST" > <!-- onsubmit="return false;"> -->
                                        <div class="form-group row">                                                    
                                            <label class="col-sm-4 col-form-label" for="ekspedisi">Ekspedisi</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control form-control-alt" id="ekspedisi" name="ekspedisi" placeholder="Nama Ekspedisi" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label" for="alamat">Alamat</label>
                                            <div class="col-sm-8">
                                                <textarea class="form-control form-control-alt" id="alamat" name="alamat" rows="5" placeholder="Alamat"></textarea> 
                                            </div>
                                        </div>
                                        <div class="form-group row">                                                    
                                            <label class="col-sm-4 col-form-label" for="telp1">Telp 1</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control form-control-alt" id="Telp1" name="telp1" placeholder="Telp 1">
                                            </div>
                                        </div>
                                        <div class="form-group row">                                                    
                                            <label class="col-sm-4 col-form-label" for="telp2">Telp 2</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control form-control-alt" id="Telp1" name="telp2" placeholder="Telp 2">
                                            </div>
                                        </div>
                                        <div class="form-group row">             
                                            <label class="col-sm-4 col-form-label" for="kodewarna">Kode Warna Cart</label>
                                            <div class="col-sm-8 js-colorpicker input-group" data-format="rgba">
                                                <input type="text" class="form-control" id="example-colorpicker4" name="kodewarna" value="" required placeholder="Kode Warna Wajib Pilih" readonly>
