...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="../../src/assets/js/plugins/bootstrap-datepicker/css/bootstrap-datepicker3.min.css">
    ...
    <body>
                ...
                <div class="js-sidebar-scroll">
                    ...
                    <div class="content-side">
                        <ul class="nav-main">
                            ...
                            <li class="nav-main-item">
                                <a class="nav-main-link active" href="<?=site_url('admin/report')?>">
                ...
                <div class="content">
                    ...
                    <div class="block block-rounded">
                        <div class="block-header block-header-default">
                            <h3 class="block-title text-danger">Report Pengiriman</h3>
                        </div>
                        <div class="block-content block-content-full">
                            <!-- Horizontal Layout -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-xl-9">
                                    ...
                                    <form class="mb-5" action="<?= site_url('admin/report/result_report'); ?>" method="POST" target="_blank"> <!-- onsubmit="return false;"> -->
                                        <div class="form-group row">                                                    
                                            <label class="col-sm-4 col-form-label" for="ekspedisi">
                                                Ekspedisi <sup><code>*Optional</code></sup>
                                            </label>
                                            <div class="col-sm-8">
                                                <select class="js-select2 form-control" id="ekspedisi" name="ekspedisi" style="width: 100%;" data-placeholder="Silahkan pilih ekspedisi" >
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label class="col-sm-4 col-form-label" >
                                                Range Date Report <sup><code>*Required</code></sup>
                                            </label>
                                            <div class="col-sm-8">
                                                <div class="form-group">
                                                    <div class="input-daterange input-group" data-date-format="yyyy-mm-dd" data-week-start="1" data-autoclose="true" data-today-highlight="true">
                                                        <input type="text" class="form-control" id="example-daterange1" name="tgl_awal" placeholder="From" data-week-start="1" data-autoclose="true" data-today-highlight="true" required>
                                                        <div class="input-group-prepend input-group-append">
                                                            <span class="input-group-text font-w600">
                                                                <i class="fa fa-fw fa-arrow-right text-danger"></i>
                                                            </span>
                                                        </div>
                                                        <input type="text" class="form-control" id="example-daterange2" name="tgl_akhir" placeholder="To" data-week-start="1" data-autoclose="true" data-today-highlight="true" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        <script src="../../src/assets/js/plugins/bootstrap-datepicker/js/bootstrap-datepicker.min.js"></script>
        <script src="../../src/assets/js/plugins/select2/js/select2.full.min.js"></script>
          
        
        <script>jQuery(function () { Dashmix.helpers(['maxlength','datepicker']); });</script>

        <script>
            $('#ekspedisi').select2({allowClear:true});
        </script>
    </body>
</html>
