...
<html lang="en">
    ...
    <body>
                ...
                <div class="js-sidebar-scroll">
                    ...
                    <div class="content-side">
                        <ul class="nav-main">
                            ...
                            <li class="nav-main-item">
                                <a class="nav-main-link active" href="<?=site_url('admin/proses')?>">
                                    <i class="nav-main-link-icon fa fa-2x fa-shipping-fast text-success"></i>
                ...
                <div class="content">
                    ...
                    <div class="block block-rounded">
                        <div class="block-header block-header-default">
                            <h3 class="block-title text-danger">Proses Pengiriman</h3>
                        </div>
                        <div class="block-content block-content-full">
                            <!-- Horizontal Layout -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-xl-9">
                                    ...
                                    <form class="mb-5" id="submit_kirim" action="<?= site_url('admin/proses/save'); ?>" method="POST" >
                                        <div class="form-group row">                                                    
                                            <label class="col-sm-4 col-form-label" for="ekspedisi">Ekspedisi</label>
                                            <div class="col-sm-8">
                                                <select class="js-select2 form-control" id="ekspedisi" name="ekspedisi" style="width: 100%;" data-placeholder="Silahkan pilih ekspedisi" required="true">
                                        ...
                                        <div class="form-group row">                                                    
                                            ...
                                            <div class="col-sm-8">
                                                <select class="js-select2 form-control" id="ecom" name="ecom[]" style="width: 100%;" data-placeholder="Silahkan pilih E-Commerce" multiple required>
                                                    <option></option><!-- Required for data-placeholder attribute to work with Select2 plugin -->
                                                    <?php foreach($ecommerce as $ecom){ ?>
                                                        <option value="<?php echo $ecom['id_ecom'] ?>"><?php echo $ecom['nama_ecom']?></option>                                                        
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label" for="resi">Resi</label>
                                            <!-- <label for="example-textarea-input-alt">Textarea</label> -->
                                            <div class="col-sm-8">
                                                <textarea class="form-control form-control-alt" id="resi" name="resi" rows="15" placeholder="" required></textarea> 
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-8 ml-auto">
                                                <button type="submit" class="btn btn-hero-primary" onclick="submit_kirim();">Save</button>
                                            </div>
                                        </div>
                                    </form>
        ...
        <script src="../../src/assets/js/plugins/select2/js/select2.full.min.js"></script>
        
        <script>jQuery(function () { Dashmix.helpers(['maxlength', 'select2']); });</script>
		
		<script>
			function submit_kirim(){ 
				var ekspedisi = $('#ekspedisi').val(); 
				var ecom = $('#ecom').val();
				var resi = $('#resi').val();
				if(ekspedisi == false){ alert('Silahkan Pilih Ekspedisi Dahulu'); return;}
				if(ecom == false){ alert('Silahkan Pilih E-Commerce Dahulu'); return;}
				if(resi == false){ alert('Silahkan Input Data Resi Dahulu'); return;}
					$('#submit_kirim').submit();
