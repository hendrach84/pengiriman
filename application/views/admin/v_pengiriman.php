...
<html lang="en">
    <head>
        ...
        <meta property="og:site_name" content="Informasi Pengiriman">
        <meta property="og:description" content="Informasi Pengiriman">
        ...
        <!-- Stylesheets -->
        <!-- Page JS Plugins CSS -->
        <link rel="stylesheet" href="../../src/assets/js/plugins/datatables/dataTables.bootstrap4.css">
        <link rel="stylesheet" href="../../src/assets/js/plugins/datatables/buttons-bs4/buttons.bootstrap4.min.css">

        <style type="text/css" class="init">
            td.details-control {
                background: url('../../src/assets/js/plugins/datatables/resources/details_open.png') no-repeat center center;
                cursor: pointer;
            }
            tr.details td.details-control {
                background: url('../../src/assets/js/plugins/datatables/resources/details_close.png') no-repeat center center;
            }
        </style>
    ...
    <body>
                ...
                <div class="js-sidebar-scroll">
                    ...
                    <div class="content-side">
                        <ul class="nav-main">
                            ...
                            <li class="nav-main-item">
                                <a class="nav-main-link active" href="<?=site_url('admin/pengiriman')?>">
                                    <i class="nav-main-link-icon fa fa-2x fa-shipping-fast text-success"></i>
                ...
                <div class="content">
                    ...
                    <div class="block block-rounded table-responsive">
                        <div class="block-header block-header-default">
                            <h3 class="block-title text-danger">Data Pengiriman</h3>
                        </div>
                        <div class="block-content block-content-full">
                            <!-- DataTables init on table by adding .js-dataTable-full class, functionality is initialized in js/pages/be_tables_datatables.min.js which was auto compiled from _js/pages/be_tables_datatables.js -->
                            <table class="table table-bordered table-hover table-striped table-vcenter display details-control" id="pengiriman" style="width: 100%;">
                                <thead>
                                    <tr>
        ...
        <script>
            function format ( d ) {
                var a = "<div class='text-muted'>List Pengiriman E-Commerce: </div>"+d.id_ecom+"</br>";
                var b = "<div class='text-muted'>List No Resi Pengiriman: </div>"+d.resi+"</br>";
                return a+b;
            }
            ...
            $(document).ready(function() {
                ...
                table = $("#pengiriman").DataTable({ 
                    ...
                    "order":[[1,"desc"]],                  
                    "ajax": {
                        "url": "<?= site_url('admin/pengiriman/get_datatable') ?>",
                        "type": "POST"
                    },
                ...
                $("#pengiriman tbody").on( "click", "tr td.details-control", function () {
